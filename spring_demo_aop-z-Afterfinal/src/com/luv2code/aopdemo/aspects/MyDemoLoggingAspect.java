...
public class MyDemoLoggingAspect {
	...
	public void afterThrowingA(JoinPoint jp,Throwable ex) {
		
		System.out.println("log exception in before returning to main method"+jp.getSignature().toShortString());
	...
	public void afterFinally(JoinPoint jp) {
		...
		System.out.println("After Finally --->"+jp.getSignature().toShortString());
